...
<head>
    ...
    <title>Sistema de inventario con reporte a Excel</title>
...
<body>
    <div class="main">
        <div class="header alert alert-dark" role="alert">Sistema de inventario v2 xdd</div>
                        ...
                        <div class="modal-body">
                            <form action="./endpoint/update-product.php" method="POST">
                                <div class="form-group" hidden>
                                    ...
                                    <input type="number" class="form-control" id="updateProductID" name="tbl_product_id">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="updateProductCode" name="product_code">
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'Orellana Matias');
